#ifndef GUICONTROLSCONSUMPTIONRATES_H
#define GUICONTROLSCONSUMPTIONRATES_H

#include "MSVPAGuiControlsNonYieldPerRecruit.h"
#include "nmfStructsQt.h"

class GuiControlsConsumptionRates : public MSVPAGuiControlsNonYieldPerRecruit
{
    Q_OBJECT
...
public:
    GuiControlsConsumptionRates();
    virtual ~GuiControlsConsumptionRates();
...
#endif // GUICONTROLSCONSUMPTIONRATES_H
