#ifndef GUICONTROLSMORTALITYRATESFORECAST_H
#define GUICONTROLSMORTALITYRATESFORECAST_H

#include "MSVPAGuiControlsNonYieldPerRecruit.h"
#include "nmfStructsQt.h"

class GuiControlsMortalityRatesForecast : public MSVPAGuiControlsNonYieldPerRecruit
{
    Q_OBJECT
...
public:
    GuiControlsMortalityRatesForecast();
    virtual ~GuiControlsMortalityRatesForecast();
...
#endif // GUICONTROLSMORTALITYRATESFORECAST_H
